...
const ProductCard = ({
  ...
  const imageUrl  = product.primaryImageUrl?.startsWith("http") ? product.primaryImageUrl : `${import.meta.env.VITE_API_URL}/${product.primaryImageUrl}`;
      ...
      <div className="p-4 font-outfit">
        ...
        <div className="flex flex-row md:flex-col lg:flex-row items-center md:items-start lg:items-center justify-between mb-3">
          ...
          <div className="flex items-center gap-1 text-text">
            ...
            <p><span>{product.seller.rating}</span> · Verified seller</p>
          </div>
        </div>
