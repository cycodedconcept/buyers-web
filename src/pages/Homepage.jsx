...
import { carFindIcon, carMoneyIcon, carHandIcon, toolsIcon } from "../assets/Assets";
...
const infoArray = [
  ...
  {icon: toolsIcon, title: "Order & Delivery Tracking", description: "Monitor orders from purchase to delivery, keeping your customers informed while ensuring a smooth fulfilment experience."}
];
...
const Homepage = () => {
  return (
		<>
				...
				<div>
					<div className="mb-9">
						...
						<p className="font-outfit text-base text-text leading-[1.4]">
							From inventory management to secure payouts, AutoParts Marketplace
							provides the tools and support you <br /> need to grow your
							business and reach customers across Nigeria.
						</p>
					</div>
					<div className="grid grid-cols-4 gap-6">
						{infoArray.map((info, index) => (
							...
							>
								...
								<h4 className="text-heading text-[20px] mt-2 mb-6">{info.title}</h4>
			...
			<Products limit={4} headingText="More Parts You May Need"/>
			<Cta ctaType="single" />
			<Testimony/>
		</>
	);
